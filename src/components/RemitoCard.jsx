...
function RemitoCard({ remito, onView, onEdit, onDelete, onDownload }) {
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <Box
            sx={{
              ...
              minWidth: 80,
              height: 80,
              backgroundColor: "#6fffa",
              borderRadius: 2,
              border: "2px solid #0097a7",

            }}
          >
            <ReceiptIcon color="primary" sx={{ fontSize: "2rem", mb: 0.5 }} />
            <Typography
              variant="caption"
              color="primary"
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            <Grid container spacing={2} sx={{ mb: 1 }}>
              <Grid item xs={12} sm={4}>
                ...
                >
                  <LocalShippingIcon
                    sx={{ fontSize: "0.9rem", color: "#388e3c" }}
                  />
                  <Typography
                    variant="body2"
              ...
              <Grid item xs={12} sm={4}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  <AttachMoneyIcon
                    sx={{ fontSize: "0.8rem", color: "#f57c00" }}
                  />
                  <Typography
                    variant="body2"
                    sx={{
                  ...
                  {remito.requiereRefrigeracion && (
                    <>
                      <AcUnitIcon
                        sx={{ color: "#2196f3", fontSize: "0.8rem", ml: 1 }}
                      />
                      <Typography
                        variant="caption"
                        color="#2196f3"
